                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 align-self-center">
                                E-mail <strong class="{{!$user->confirmedEmail() ? "text-danger" : "text-success"}}"> {{!$user->confirmedEmail() ? "не подтвержден" : "подтвержден"}}</strong>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-sm-12 text-center">
                                    ...
                                    <button class="btn btn-block btn-outline-primary">Подтвердить E-mail</button>
                                </div>
                                <div class="col-md-6 col-sm-12 text-center">
